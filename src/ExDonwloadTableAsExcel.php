...
class DownloadTableAsExcel extends CApplicationComponent
{
    public $headers = [];
    public $data = [];
    public $options = [];
    ...
    public function create($saveAsFile=true, $filename=null)
    {
        ...
        foreach ($this->headers as $header) {
            ...
            $worksheet->setCellValue($header['column'].'1', $row['title']);
        }
        ...
        header("Content-Disposition: attachment;filename=\"{$opt[filename_prepend]} {$today}.xls\"");
    ...
    protected function getDefaultOptions()
    {
        return array(
            ...
            'filename_prepend'=>'Export Project',
